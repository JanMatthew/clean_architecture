...
class CharacterBloc extends Bloc<CharacterEvent, CharacterState> { 
  ...
  // Actualizar el estado para indicar que estamos cargando 
    ...
    final result = await getAllCharacters(); result.fold( 
      // En caso de error, actualizar el estado con el mensaje de error 
      (error) => emit( state.copyWith(isLoading: false, errorMessage: error.toString())), 
      ...
      (characters) { 
        ...
        emit(state.copyWith(isLoading: false, characters: 
        filteredCharacters)); 
      }, 
    );
  } 
